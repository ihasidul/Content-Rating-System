...
define('POSTERS', ROOT . 'public' . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'poster' . DIRECTORY_SEPARATOR);
...
$modules = [ROOT, APP, CORE, CONTROLLERS, DATA, INCLUDES, POSTERS];
